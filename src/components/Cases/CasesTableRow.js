const CasesTableRow = (props) => {
    return (
      <div className="cases-table-row">
        <div className="cases-col title-col long">
          <h5>{props.col1}</h5>
        </div>
        <div className="cases-col long"><h5>{props.col2}</h5></div>
        <div className="cases-col"><h5>{props.col3}</h5></div>
        <div className="cases-col"><h5>{props.col4}</h5></div>
        <div className="cases-col medium"><h5>{props.col5}</h5></div>
        <div className="cases-col"><h5>{props.col6}</h5></div>
        <div className="cases-col"><h5>{props.col7}</h5></div>
        <div className="cases-col medium"><h5>{props.col8}</h5></div>
